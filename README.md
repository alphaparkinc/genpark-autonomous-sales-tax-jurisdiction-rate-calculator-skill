# genpark-autonomous-sales-tax-jurisdiction-rate-calculator-skill
...
> **GenPark AI Agent Skill** -- Autonomous sales tax calculation and multi-state economic nexus detector (Numeral style)
